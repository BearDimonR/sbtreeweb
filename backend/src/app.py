...
import datetime
from data.test_data import inject_test_data
...
def init_logs():
    ...
    logging_handler = RotatingFileHandler(
        filename=os.path.join(
            LOG_FOLDER, f'{datetime.datetime.today().strftime("%Y-%m-%d")}.log'
        ),
        mode="a",
...
def init_app():
    ...
    # recreate database and import data from Google Sheets or some test data
