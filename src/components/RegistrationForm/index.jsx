...
const RegistrationForm = ({register: signUp, toggle, setIsLoading, isLoading, isVisible}) => {
                ...
                <Grid.Column className={style.formGrid}>
                    <div className={style.formRegistration}>
                        ...
                        <Form className={style.form} onSubmit={register}>
                            ...
                            <Button
                                disabled={errors.name || errors.email || errors.password || _.isEmpty(password) || _.isEmpty(email)}
                                type="submit"
                        ...
                        <p className={style.formSwitcher} onClick={() => toggle(LOGIN_WORD)}>Have an account?</p>
                    </div>
                </Grid.Column>
            </Grid.Row>
        </Grid>
